...
3. **[questions.js](file:///D:/Study/WebPage/EngLevelTest/questions.js)**
   - 초급(A1-A2), 중급(B1-B2), 고급(C1-C2) 단계별로 엄선된 어휘, 문법, 독해 등 총 60개의 문제(레벨별 20개 문제 풀)와 정답 정보가 한글 해설과 함께 포함되어 있습니다.
4. **[app.js](file:///D:/Study/WebPage/EngLevelTest/app.js)**
   ...
   - Fisher-Yates 셔플 알고리즘을 사용한 20문제 중 10문제 무작위 추출 및 섞기 기능을 포함합니다.
...
- 각 레벨별로 20문제의 풍부한 문제 은행이 내장되어 있습니다.
- 테스트 시작 시 **Fisher-Yates 셔플 알고리즘**을 사용해 20문제 전체를 무작위로 섞은 뒤 앞의 10문제만 골라 출제합니다.
